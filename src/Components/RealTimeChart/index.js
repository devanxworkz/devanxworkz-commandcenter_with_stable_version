    ...
    return (
      <div className="text-sm text-gray-300">
        ...
        <div className="flex justify-around items-center text-center">
          <div className="flex flex-col items-center">
            <p className="text-[14px] text-gray-400">
              Min Voltage : <span className="font-semibold text-white">{minCellValue}</span>
            </p>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-[14px] text-gray-400">
              Max Voltage : <span className="font-semibold text-white">{maxCellValue}</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-around items-center text-center mt-1">
          <div className="flex flex-col items-center">
            <p className="text-[14px] text-gray-400">
              Min Cell No : <span className="font-semibold text-white">{minCellNumber}</span>
            </p>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-[14px] text-gray-400">
              Max Cell No : <span className="font-semibold text-white">{maxCellNumber}</span>
            </p>
          </div>
        </div>
      </div>
